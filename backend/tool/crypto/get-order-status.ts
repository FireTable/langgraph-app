...
// (the real CoW /orders/{uid} endpoint can't find the synthetic uid
// from a simulated place_crypto_order, so we don't even try). The
// synthesized status flows back to the LLM as-is via the resume.
