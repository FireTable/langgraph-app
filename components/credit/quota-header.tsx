...
// spacing (e.g. pb-1.5 for the QuotaProgress variant's extra
// breathing room before the "Used X / Y" line).
export function QuotaHeader({ className }: { className?: string }): React.JSX.Element {
  return (
